...
use iroh_net::defaults::{DEFAULT_DERP_STUN_PORT, DEFAULT_NA_DERP_HOSTNAME};
use iroh_net::hp::{
    derp::{
        self,
        http::{
...
struct Config {
    ...
    stun_port: u16,
    /// Certificate hostname. Defaults to [`DEFAULT_NA_DERP_HOSTNAME`].
    hostname: String,
...
impl Default for Config {
    fn default() -> Self {
        Self {
            ...
            hostname: DEFAULT_NA_DERP_HOSTNAME.into(),
            enable_stun: true,
            enable_derp: true,
            tls: None,
            limits: None,
