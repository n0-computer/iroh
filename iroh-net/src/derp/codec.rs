...
///
/// Does not flush.
pub(super) async fn write_frame<S: Sink<WriteFrame, Error = std::io::Error> + Unpin>(
    mut writer: S,
    frame: WriteFrame,
...
pub(super) async fn recv_client_key<S: Stream<Item = anyhow::Result<WriteFrame>> + Unpin>(
