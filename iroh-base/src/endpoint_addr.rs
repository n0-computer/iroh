...
///
/// - A [endpoint_id_resolution] service which can provide routing information for a given [`EndpointId`].
///
...
///
/// [endpoint_id_resolution]: https://docs.rs/iroh/*/iroh/index.html#endpoint-id-resolution
