...
use iroh::{
    ...
    endpoint::{Connection, ConnectionError, QuicTransportConfigBuilder, RecvStream, SendStream},
};
...
pub fn transport_config(max_streams: usize, initial_mtu: u16) -> QuicTransportConfigBuilder {
