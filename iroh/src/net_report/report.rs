...
impl Report {
    ...
    pub(super) fn update_https(&mut self, report: &HttpsProbeReport) {
        self.relay_latency
            .update_relay(report.relay_url.clone(), report.latency, Probe::Https);
    }
    ...
    pub(super) fn update_qad_v4(&mut self, report: &QadProbeReport) {
        self.relay_latency
            .update_relay(report.relay_url.clone(), report.latency, Probe::QadIpv4);
    ...
    pub(super) fn update_qad_v6(&mut self, report: &QadProbeReport) {
        self.relay_latency
            .update_relay(report.relay_url.clone(), report.latency, Probe::QadIpv6);
