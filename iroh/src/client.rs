...
use crate::rpc_protocol::{
    ...
    DocImportRequest, DocInfoRequest, DocListRequest, DocSetRequest, DocSetStreamRequest,
    DocSetStreamUpdate, DocShareRequest, DocStartSyncRequest, DocStopSyncRequest,
