...
<body>
  <div id="page-header">
    ...
    <div id="page-header-menu">
			<div class="menu-item-wide"><a href="https://iroh.computer/docs/install" target="_blank" rel="noopener noreferrer">Install IPFS</a></div>
...
pub const ICONS_STYLESHEET_TEMPLATE: &str = r##"
